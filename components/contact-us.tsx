        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
            {teamMembers.map((member) => (
              ...
              >
                <div className="mb-4 h-24 w-24 overflow-hidden rounded-full border-4 border-blue-600 shadow-lg shadow-blue-900/50">
                  <Image
                ...
                <p className="mb-4 text-sm text-blue-400">{member.role}</p>
                <div className="space-y-2 w-full">
                  <a
                    href={`mailto:${member.email}`}
                    className="flex items-center justify-center space-x-2 text-xs text-gray-300 hover:text-blue-400 transition-colors group"
                  >
                    <Mail className="h-3 w-3 text-blue-500 group-hover:text-blue-400" />
                  ...
                  <a
                    ...
                    className="flex items-center justify-center space-x-2 text-xs text-gray-300 hover:text-blue-400 transition-colors group"
                  >
                    <Phone className="h-3 w-3 text-blue-500 group-hover:text-blue-400" />
